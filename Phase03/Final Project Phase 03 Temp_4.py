...
def loadUserPage():
    ...
    andrew_picture.place(x=320,y=150)
...
def about_us_page():
    ...
    nick_image = tk.PhotoImage(file="Defaultpic.png")
    nick_picture = tk.Label(window9, image=nick_image)
    nick_picture.place(x=20,y=250)
    andrew_image = tk.PhotoImage(file="DefaultPic.png")
    andrew_picture = tk.Label(window9, image=andrew_image)
    andrew_picture.place(x=190,y=250)
    chris_image = tk.PhotoImage(file="DefaultPic.png")
    chris_picture = tk.Label(window9, image=chris_image)
    chris_picture.place(x=420,y=250)
    ben_image = tk.PhotoImage(file="DefaultPic.png")
    ben_picture = tk.Label(window9, image=ben_image)
    ben_picture.place(x=620,y=250)
